# Gemini Instructions for Espace Image Dashboard

## Project Overview
**Espace Image** is a FastAPI-based dashboard application serving modern and legacy UIs (iPad 2 / iOS 9.3.5). It features photo slideshows, calendar alarms, weather widgets, and HTMX-powered admin interactions.
