...
templates.env.globals["legacy_weather_interval_ms"] = (
    METEO_SYNC_INTERVAL_MINUTES * 60 * 1000
)
...
templates.env.globals["legacy_index_update_interval_ms"] = (
    INDEX_UPDATE_INTERVAL_SECONDS * 1000
)
