...
Derived from `.github/agents/beast-lite.agent.md`.
...
5. Validate changes with errors, tests, build, or lint checks where relevant.
...
- Keep contracts and implementations aligned.
